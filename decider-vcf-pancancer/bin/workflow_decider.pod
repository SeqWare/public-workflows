...
=item --schedule-sample-whitelist[=][ ]<filename>
...
=item --schedule-donor-whitelist[=][ ]<filename>
...
=item --schedule-sample-blacklist[=][ ]<filename>
...
=item --schedule-donor-blacklist[=][ ]<filename>
