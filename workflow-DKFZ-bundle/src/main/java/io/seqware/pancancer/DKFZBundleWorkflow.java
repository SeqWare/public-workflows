 ...
 * DKFZ SNV Calling - DKFZ Indel Calling - DKFZ Copy number estimation
 *
 * All workflows themselves are implemented in such a way that they use SGE
 * directly to run their jobs.
 *
 * All workflows basically rely on two merged bam (control and tumor sample)
 * files as input files. In addition, the copy number estimation workflow needs
 * input files from EMBL's delly workflow.
 */
public class DKFZBundleWorkflow extends AbstractWorkflowDataModel {
    ...
    /**
     * Extract the uuid of an object from its url. Example:
     * https://gtrepo-dkfz.annailabs.com/cghub/metadata/analysisFull/174bdd2d-1810-4890-af87-8aef4827eb3c
     * => 174bdd2d-1810-4890-af87-8aef4827eb3c
     *
     * @param url
     * @return
     */
