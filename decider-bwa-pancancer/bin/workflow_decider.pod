...
=item --working-dir[=][ ]<working-directory>

A place for temporary ini and settings files

=for Euclid
    working-directory.default: 'decider_tmp'
...
=for Euclid
   seqware_settings.default: 'seqware.settings'
...
=item --output-prefix[=][]<output-prefix>
...
=for Euclid
   output-directory.defualt: 'seqware-results/'
