#!/usr/bin/perl
#
# File: pcap_data_freeze_2.0_report_generator.pl
# 
...
sub process_specimens {
    ...
    print $FH "Study\tProject Code\tDonor ID\tSpecimen/Sample ID\tSample/Aliquot ID\tNormal/Tumour designation\tAnalyzed Sample/Aliquot GUUID\tGNOS endpoint\n";
    foreach my $project (sort keys %{$sample_info}) {
