...
input_reference=\${workflow_bundle_dir}/Workflow_Bundle_BWA/2.3.0/data/reference/bwa-0.6.2/genome.fa.gz
...
gnos_key=\${workflow_bundle_dir}/Workflow_Bundle_BWA/2.3.0/scripts/gnostest.pem
